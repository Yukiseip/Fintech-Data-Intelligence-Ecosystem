...
echo "========================================"
echo " Step 0: Stop old backfills"
echo "========================================"
pkill -f "fast_final_backfill.sh" || true
pkill -f "silver_cleanse.py" || true

echo "========================================"
echo " Step 1: Re-running Silver for ALL days at once"
echo "========================================"
spark-submit ${SPARK_CONF} /opt/spark/jobs/silver_cleanse.py --date "all" --bucket "${BUCKET}"
